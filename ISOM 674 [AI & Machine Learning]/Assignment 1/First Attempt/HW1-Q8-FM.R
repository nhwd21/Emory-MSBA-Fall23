...
# Convert to Matrix, Specify Columns --------------------------------------
...
# create new matrixes to store transformed values
...
out <- knn.reg(train=train_data_x_t,test=test_data_x_t,y=train_data_y,k=BestK)
